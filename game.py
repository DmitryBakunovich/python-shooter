...
pygame.display.set_caption("ЛУЧШЕ ЧЕМ ГИТИА ПЯТЬ!")
...
while True:
    ...
    if player_2 and player.id == 2:
        text2 = f2.render(f'{player.score}:{player_2.score}', 0, (0, 180, 0))
    elif player_2 and player.id == 1:
        text2 = f2.render(f'{player_2.score}:{player.score}', 0, (0, 180, 0))
    else:
